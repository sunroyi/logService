...
public class EventCount {
    ...
    然后把这些文件复制到HDFS上
    $ bin/hdfs dfs -put /tmp/input /user/sun/input

    运行mapreduce作业
    $ bin/hadoop jar hadoopstudy-1.0-SNAPSHOT.jar my.hadoopstudy.mapreduce.EventCount /user/sun/input /user/sun/output

    查看执行结果
    $ bin/hdfs dfs -cat /user/sun/output/part-r-00000
    */
}